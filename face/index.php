...
<html>
	...
	<body style="align-items: center; text-align: center; background: #add8e6;">
	<script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script>
	<center><lottie-player src="https://assets3.lottiefiles.com/datafiles/9mOTENIS7sCU37f/data.json"  background="transparent"  speed="1"  style="width: 150px; height: 150px;"  loop autoplay></lottie-player></center>
		<hr />
		<p>
			<center>
				<input type="button" style="border: 1px solid grey; padding: 8px 15px; background: white; border-radius: 8px" value="Start Webcam" onclick="button_callback()">
				&nbsp;
				<a href="view.php" target="_blank" style="border: 1px solid grey; padding: 8px 15px; background: white; border-radius: 8px; text-decoration: none;">View Saved Data</a>
			</center>
		</p>
		<hr />
		<p>
